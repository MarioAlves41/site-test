  ...
  return (
    <div className="App">
      ...
      <nav>
        ...
        <header className="carp">
          <div className="header-body">
            <div>
              <h1>Join the Jorney</h1>
              <p>
                Leaner and meaner then ever. The new Audi porsche boddly goes where
        ...
        <div className="about">
          <div className="heading">
            ...
            <p>
              The porsche can't help but steal the spotlight. With its sharp angular
              lines <br /> and exotic, glass covered engine, the porsche has a Wide
        ...
        <div className="infos">
          <div className="info">
            ...
            <div>
              <h3>Agility</h3>
              <p>Built for speed, with a 4 liter V8 enginge</p>
            </div>
          </div>
          <div className="info">
            ...
            <div>
              <h3>Performance</h3>
              <p>Accelerating from zero to 60 mph in 4.1s</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                <span>641.00 bhp @6500 rpm</span>
              </li>
              <li>
                <span>Maximum torque</span>
                <span>450 Nm 1950–5000 rpm </span>
              </li>
              <li>
