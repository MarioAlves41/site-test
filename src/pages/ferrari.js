...
import ferrariroma from "./img/ferrariroma.png";

function cferrari() {
  return (
    <div className="App">
      <section>
      <header className="carferrari">
            <div className="header-body">
              <div>
                <h1>Join the Jorney</h1>
                <p>
                  Leaner and meaner then ever. The new ferrariroma boddly goes where
        ...
        <div className="about">
          <div className="heading">
            ...
            <p>
              The ferrariroma can't help but steal the spotlight. With its sharp angular
              lines <br /> and exotic, glass covered engine, the ferrariroma has a Wide
        ...
        <div className="infos">
          <div className="info">
            ...
            <div>
              <h3>Agility</h3>
              <p>Built for speed, with a 3.9 liter V8 enginge</p>
            </div>
          </div>
          <div className="info">
            ...
            <div>
              <h3>Performance</h3>
              <p>Accelerating from zero to 60 mph in 3.4s</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                <span>611 @ 7500 rpm</span>
              </li>
              <li>
                <span>Maximum torque</span>
                <span>561 @ 3000 rpm </span>
              </li>
              <li>
